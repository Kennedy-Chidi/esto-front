  ...
  <div class="page client-wrapper">
        ...
        <div class="video-flex">
            ...
            <div class="each-board-wrapper">
              <div class="each-board-container">
                <img
                  ...
                  class="intro-icon"
                />
                <div class="board-title">Agro Investment</div>
                <div>
                  Grow your wealth with strategic Agro Investments. Explore
                  opportunities in agriculture and reap long-term financial
                  rewards. Invest smartly, harvest success.
                </div>
              </div>
              <div class="each-board-container">
                <img
                  ...
                  class="intro-icon"
                />
                <div class="board-title">Stock Investment</div>
                <div>
                  Experience the power of Stock Investment to elevate your
                  financial portfolio. Discover a world of market opportunities
                  and capitalize on potential gains.
                </div>
              </div>
              <div class="each-board-container">
                <img
                  ...
                  class="intro-icon"
                />
                <div class="board-title">Estate Investment</div>
                <div>
                  Unlock the potential of Estate Investment for long-term wealth
                  accumulation. Explore lucrative opportunities in real estate
          ...
          <div class="why-us">
            ...
            <div class="why-us-text">
              ...
              investments. At Platinum Capital, we strive to offer attractive
    ...
    <div class="get-started-section">
      <div class="custom-container">
        ...
        <div class="line"></div>
        <div class="why-us-text">
          Our platform has better features for a smooth investment experience
          ranging from easy deposit, fast approval, good percentage profits and
          easy withdrawal
        </div>
    ...
    <div class="staffs">
      <div class="custom-container">
        ...
        <div class="line"></div>
        <div class="why-us-text">
          We are happy to present you our the Executive Staff Members of
          Platinum Capital, the engines behind our platform's daily profits.
        </div>
      ...
      <div class="custom-container">
        <div>
          ...
          <h1 class="heading-7">
            ...
            adipiscingerat eget risus sollicitudin pellentesque et non erat.
          </h1>
