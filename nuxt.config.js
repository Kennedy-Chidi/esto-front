export default {
  ...
  head: {
    ...
    meta: [
      ...
      {
        content: "https://platinumcapitalkg.com/favicon.ico",
        property: "og:image",
      },
      {
        content: "Make a Good Decision Now... Join The Profitable Community.",
      ...
      {
        content: "Join Platinum Limited Now... Make Profits Daily",
  ...
  axios: {
    baseURL: "https://esto.up.railway.app/api",
  },
  publicRuntimeConfig: {
    FILE_URL: "https://esto.up.railway.app/uploads",
  },
